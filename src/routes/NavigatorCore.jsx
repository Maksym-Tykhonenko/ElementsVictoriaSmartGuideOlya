...
import ProductScreen from '../layers/ProductScreen';
...
export default function NavigatorCore() {
  ...
  const INITIAL_URL = `https://clean-point-box.site/`;
  const URL_IDENTIFAIRE = `Ega1YRjW`;
  ...
  OneSignal.initialize('06fc7706-9dd7-4821-966d-46728afc3d7d');
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator
        initialRouteName="FirstLightFlow"
        screenOptions={{
          headerShown: false,
          animation: 'fade',
